    ...
    echo div_open('container','');
      echo div_open('row','');
        echo div_open('col-md-4','');
          ...
          echo div_open('panel panel-primary col-m-4','');

            echo div_open('panel-heading','');
              echo "<h4 class='panel-title'>";
                echo "Datos de la Ficha";
              echo "</h4>";
            echo div_close();
            echo div_open('panel-body','');
              echo div_open('container','');
                    $attributes = array('class' => 'form-horizontal col-md-3', 'role' => 'form');
                  ...
                  echo div_open('col-md-5','');
                  //panel fichas registradas previamente
                  echo div_open('panel panel-primary col-md-3','');
                    ...
                    echo div_close();
                    echo div_open('panel-body','');
                      echo div_open('container',''); //open container
